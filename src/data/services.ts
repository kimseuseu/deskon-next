...
export const services: ServiceData[] = [
  ...
  // === BUYBACK (4) ===
  {
    ...
    title: "사무가구 매입",
    subtitle:
      "사무실 이전, 축소, 리모델링 시 불필요한 사무가구를 AOVO가 합리적인 가격으로 매입합니다. 책상, 의자, 캐비닛, 파티션 등 보유 장비를 간편한 매입 절차로 정리하고 공간 효율화를 실현하세요. 무료 방문 견적과 당일 수거로 빠르게 자산을 정리할 수 있습니다.",
    heroGradient: "from-stone-900 to-stone-600",
    features: [
      {
        icon: "💰",
        title: "합리적인 매입 가격",
        description:
          "보유 장비의 상태, 브랜드, 연식을 정밀 평가하여 합리적인 가격으로 매입합니다. 투명한 견적 산출 기준을 공개합니다.",
      },
      {
        icon: "🚛",
        title: "무료 방문 수거",
      ...
      },
      {
        ...
        title: "간편한 매입 절차",
        description:
          "온라인 또는 전화로 매입을 문의하면 방문 견적, 수거, 정산까지 원스톱으로 진행하여 불필요한 자산 정리가 간편합니다.",
      },
    ],
    process: [
      {
        step: 1,
        title: "매입 문의",
        description: "매입할 사무가구의 종류, 수량, 사진을 보내주시면 사전 견적을 안내합니다",
      },
      {
        step: 2,
        title: "방문 견적",
        description: "전문 평가사가 현장을 방문하여 장비 상태를 확인하고 최종 매입가를 제시합니다",
      },
      {
        step: 3,
        title: "수거",
        description: "매입가 합의 후 전문 수거 팀이 분류·포장·운반을 무료로 진행합니다",
      },
      {
        step: 4,
        title: "정산",
        description: "수거 완료 후 합의된 매입 대금을 지정 계좌로 신속하게 정산합니다",
      },
    ],
    metaDescription:
      "AOVO 사무가구 매입 - 사무실 이전·축소 시 보유 사무가구를 합리적인 가격으로 매입합니다. 무료 방문 수거, 간편 절차.",
  },
  {
    category: "buyback",
    categoryLabel: "매입서비스",
    ...
    title: "물류장비 매입",
    subtitle:
      "더 이상 사용하지 않는 롤테이너, 파랫트, 인테이너, 대차 등 물류장비를 AOVO가 합리적인 가격으로 매입합니다. 창고 축소, 물류 체계 변경 등으로 불필요해진 장비를 간편하게 정리하여 공간 효율화와 자산 회수를 동시에 실현하세요.",
    ...
    features: [
      {
        ...
        title: "합리적인 매입 가격",
        description:
          "장비의 종류, 수량, 상태를 전문 평가하여 합리적인 가격으로 매입합니다. 대량 매입 시 우대 가격을 적용합니다.",
      },
      {
        icon: "🚛",
        title: "전국 무료 수거",
      ...
      },
      {
        ...
        title: "대량 매입 대응",
        description:
          "물류센터 폐쇄, 창고 이전 등 대량 장비도 일괄 매입이 가능합니다. 현장 방문 후 즉시 견적을 제시합니다.",
      },
    ],
    process: [
      {
        step: 1,
        title: "매입 문의",
        description: "매입할 물류장비의 종류, 규격, 수량, 상태를 알려주시면 사전 견적을 안내합니다",
      },
      {
        step: 2,
        title: "방문 견적",
      ...
      },
      {
        step: 3,
        title: "수거",
        description: "매입가 합의 후 전문 수거 팀이 장비를 안전하게 수거·운반합니다",
      },
      {
        step: 4,
        title: "정산",
    ...
    metaDescription:
      "AOVO 물류장비 매입 - 롤테이너, 파랫트 등 불필요한 물류장비를 합리적인 가격으로 매입합니다. 전국 무료 수거.",
  },
  {
    category: "buyback",
    categoryLabel: "매입서비스",
    ...
    title: "행사집기 매입",
    subtitle:
      "행사 대행업체, 웨딩홀, 연회장 등에서 보유한 접이식 테이블, 연회 의자, 파티션, 무대장비 등 불필요한 행사집기를 AOVO가 합리적인 가격으로 매입합니다. 장비 교체, 업종 변경, 폐업 시 간편한 매입 절차로 공간 효율화와 자산 회수를 실현하세요.",
    ...
    features: [
      {
        ...
        title: "합리적인 매입 가격",
        description:
          "행사집기의 종류, 브랜드, 상태를 전문 평가하여 합리적인 가격으로 매입합니다. 세트 일괄 매입 시 우대 가격을 적용합니다.",
      },
      {
        icon: "🚛",
        title: "무료 방문 수거",
    ...
    process: [
      {
        step: 1,
        title: "매입 문의",
        description: "매입할 행사집기의 종류, 수량, 사진을 보내주시면 사전 견적을 안내합니다",
      },
      {
        step: 2,
        title: "방문 견적",
        description: "전문 평가사가 현장을 방문하여 집기 상태를 확인하고 최종 매입가를 제시합니다",
      },
      {
        step: 3,
        title: "수거",
    ...
    metaDescription:
      "AOVO 행사집기 매입 - 테이블, 의자, 파티션 등 불필요한 행사집기를 합리적인 가격으로 매입합니다. 무료 방문 수거.",
  },
  {
    category: "buyback",
    categoryLabel: "매입서비스",
    ...
    title: "업소용집기 매입",
    subtitle:
      "식당 폐업, 리모델링, 업종 변경 시 보유한 업소용 주방장비와 집기를 AOVO가 합리적인 가격으로 매입합니다. 업소용 냉장고, 가스레인지, 식기세척기, 조리대, 테이블, 의자 등 불필요한 장비를 간편하게 정리하여 공간 효율화를 실현하세요.",
    ...
    features: [
      {
        ...
        title: "합리적인 매입 가격",
        description:
          "업소용 장비의 브랜드, 연식, 상태를 전문 평가하여 합리적인 가격으로 매입합니다. 매장 전체 일괄 매입도 가능합니다.",
      },
      {
        icon: "🚛",
        title: "무료 방문 수거",
      ...
      },
      {
        ...
        title: "간편한 매입 절차",
        description:
          "폐업·리모델링 시 매장 내 모든 장비를 일괄 매입하여 한번에 정리합니다. 별도 폐기 비용 없이 자산을 회수할 수 있습니다.",
      },
    ],
    process: [
      {
        step: 1,
        title: "매입 문의",
        description: "매입할 업소용 장비의 종류, 수량, 사진을 보내주시면 사전 견적을 안내합니다",
      },
      {
        step: 2,
        title: "방문 견적",
        description: "전문 평가사가 매장을 방문하여 장비 상태를 확인하고 최종 매입가를 제시합니다",
      },
      {
        step: 3,
        title: "수거",
        description: "매입가 합의 후 전문 수거 팀이 장비 해체·포장·운반을 무료로 진행합니다",
      },
      {
        step: 4,
        title: "정산",
    ...
    metaDescription:
      "AOVO 업소용집기 매입 - 식당 폐업·리모델링 시 업소용 장비를 합리적인 가격으로 매입합니다. 무료 방문 수거, 일괄 정리.",
  },
]; 사무실 이전, 인원 축소, 리모델링 등으로 처분이 필요한 사무가구를 적정 가격에 매입하여 폐기 비용 부담을 줄여드립니다. 전국 어디든 방문하여 현장 감정 후 당일 매입이 가능합니다.",
    heroGradient: "from-teal-950 to-teal-700",
    features: [
      { icon: "🏢", title: "현장 방문 즉시 감정", description: "전문 감정사가 직접 현장을 방문하여 사무가구의 상태, 브랜드, 연식을 평가하고 즉석에서 매입 가격을 제시합니다." },
      { icon: "💰", title: "당일 매입·정산", description: "감정 완료 후 합의된 가격으로 당일 매입하고, 영업일 기준 1일 이내에 정산을 완료합니다." },
      { icon: "🚚", title: "무상 수거·운반", description: "매입이 확정된 가구는 전문 운반팀이 무상으로 수거합니다. 해체·포장·운반까지 전 과정을 책임집니다." },
      { icon: "📋", title: "자산 처분 증빉 발급", description: "매입 완료 후 자산 처분 확인서를 발급하여 회계 처리와 세무 신고에 필요한 증빉 자료를 제공합니다." },
    ],
    process: [
      { step: 1, title: "매입 문의", description: "처분할 사무가구의 품목, 수량, 사진을 접수합니다" },
      { step: 2, title: "현장 감정", description: "전문 감정사가 방문하여 상태를 확인하고 매입가를 제시합니다" },
      { step: 3, title: "매입 확정·수거", description: "합의된 가격으로 매입을 확정하고 가구를 수거합니다" },
      { step: 4, title: "정산 완료", description: "영업일 1일 이내 매입 대금을 정산하고 처분 증빉을 발급합니다" },
    ],
    metaDescription: "AOVO 사무가구 매입 - 사무용 책상, 의자, 캐비닛 등을 현장 감정 후 즉시 매입합니다. 무상 수거, 당일 정산, 자산 처분 증빉 발급.",
  },
  {
    category: "buyback",
    categoryLabel: "매입서비스",
    ...
    title: "물류장비 매입",
    subtitle:
      "롤테이너, 파랫트, 대차 등 물류장비를 전문 감정 후 매입합니다. 물류센터 통폐합, 장비 교체, 운영 축소 시 유휴 물류장비를 적정 가격에 처분할 수 있습니다. 대량 매입도 가능하며, 전국 물류센터에 방문하여 현장 감정을 진행합니다.",
    heroGradient: "from-teal-950 to-teal-700",
    features: [
      { icon: "📦", title: "대량 매입 전문", description: "롤테이너 100대 이상, 파랫트 500장 이상 등 대량 물류장비를 한꺼번에 매입합니다. 수량이 많을수록 유리한 단가를 제시합니다." },
      { icon: "🔍", title: "전문 장비 감정", description: "프레임 변형, 바퀴 상태, 용접 부위 등을 전문적으로 감정하여 공정한 매입가를 산정합니다." },
      { icon: "🚛", title: "전국 물류센터 방문", description: "전국 어디든 물류센터에 직접 방문하여 감정하고, 매입 확정 시 자체 차량으로 수거합니다." },
      { icon: "📊", title: "재고 자산 정리 지원", description: "매입 내역서, 자산 처분 확인서 등 재고 자산 정리에 필요한 서류를 제공합니다." },
    ],
    process: [
      { step: 1, title: "매입 문의", description: "처분할 물류장비의 품목, 수량, 상태를 접수합니다" },
      { step: 2, title: "현장 감정", description: "전문 감정팀이 물류센터를 방문하여 장비 상태를 확인합니다" },
      { step: 3, title: "매입 확정·수거", description: "합의된 가격으로 매입을 확정하고 자체 차량으로 수거합니다" },
      { step: 4, title: "정산·서류 발급", description: "매입 대금을 정산하고 자산 처분 증빉을 발급합니다" },
    ],
    metaDescription: "AOVO 물류장비 매입 - 롤테이너, 파랫트, 대차 등 유휴 물류장비를 대량 매입합니다. 전국 방문 감정, 무상 수거, 신속 정산.",
  },
  {
    category: "buyback",
    categoryLabel: "매입서비스",
    ...
    title: "행사집기 매입",
    subtitle:
      "행사용 테이블, 의자, 부스, 파티션 등 행사집기를 매입합니다. 대규모 행사 종료 후 대량으로 남은 행사 장비를 일괄 매입하여 빠르게 처분할 수 있도록 도와드립니다. 현장에서 직접 수거까지 완료합니다.",
    heroGradient: "from-teal-950 to-teal-700",
    features: [
      { icon: "🎪", title: "행사 종료 즉시 매입", description: "행사가 끝나면 현장에서 바로 장비를 감정하고 매입합니다. 행사장 철수 일정에 맞춰 신속하게 처리합니다." },
      { icon: "📋", title: "일괄 매입 가능", description: "테이블, 의자, 부스, 파티션 등 다양한 행사집기를 품목 구분 없이 한꺼번에 매입합니다." },
      { icon: "🚚", title: "현장 수거 완료", description: "매입 확정 후 전문 팀이 현장에서 직접 해체·포장·수거까지 완료합니다. 별도 운반 비용이 없습니다." },
      { icon: "💰", title: "합리적 매입가 제시", description: "장비의 상태, 브랜드, 잔여 수명을 종합 평가하여 공정하고 합리적인 매입가를 제시합니다." },
    ],
    process: [
      { step: 1, title: "매입 문의", description: "행사 종료일, 장비 목록, 사진 등을 접수합니다" },
      { step: 2, title: "현장 감정", description: "행사장에 방문하여 장비 상태를 확인하고 매입가를 제시합니다" },
      { step: 3, title: "매입 확정·수거", description: "합의된 가격으로 매입하고 현장에서 바로 수거합니다" },
      { step: 4, title: "정산 완료", description: "매입 대금을 신속히 정산하고 처분 확인서를 발급합니다" },
    ],
    metaDescription: "AOVO 행사집기 매입 - 행사용 테이블, 의자, 부스, 파티션 등을 행사 종료 후 즉시 매입합니다. 현장 수거, 일괄 매입, 신속 정산.",
  },
  {
    category: "buyback",
    categoryLabel: "매입서비스",
    ...
    title: "업소용집기 매입",
    subtitle:
      "식당, 카페, 호텔 등에서 사용하던 업소용 주방장비, 테이블, 의자 등을 매입합니다. 폐업, 인테리어 리뉴얼, 장비 교체 시 업소용 집기를 적정 가격에 처분할 수 있습니다. 대형 장비도 전문 팀이 안전하게 수거합니다.",
    heroGradient: "from-teal-950 to-teal-700",
    features: [
      { icon: "🍳", title: "업소용 장비 전문 감정", description: "주방장비, 냉장고, 제빙기 등 업소용 전문 장비의 상태와 시장 가치를 정확히 감정합니다." },
      { icon: "🏪", title: "폐업·리뉴얼 일괄 매입", description: "폐업이나 인테리어 리뉴얼 시 매장 내 집기를 품목 구분 없이 일괄 매입하여 한 번에 정리해 드립니다." },
      { icon: "🔧", title: "대형 장비 안전 수거", description: "냉장 쇼케이스, 업소용 오븐 등 대형 장비도 전문 장비와 인력으로 안전하게 해체·수거합니다." },
      { icon: "📄", title: "세무 증빉 발급", description: "매입 확인서, 세금계산서 등 폐업 절차와 세무 처리에 필요한 증빉 서류를 발급합니다." },
    ],
    process: [
      { step: 1, title: "매입 문의", description: "처분할 업소용 집기의 품목, 수량, 사진을 접수합니다" },
      { step: 2, title: "현장 감정", description: "매장에 방문하여 장비 상태를 확인하고 매입가를 제시합니다" },
      { step: 3, title: "매입 확정·수거", description: "합의 후 대형 장비 포함 전 품목을 안전하게 수거합니다" },
      { step: 4, title: "정산·증빉 발급", description: "매입 대금을 정산하고 세무 증빉 서류를 발급합니다" },
    ],
    metaDescription: "AOVO 업소용집기 매입 - 식당, 카페, 호텔 업소용 주방장비, 가구를 전문 감정 후 매입합니다. 폐업·리뉴얼 일괄 매입, 대형 장비 수거.",
  },
];
