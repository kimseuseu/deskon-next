...
export const services: ServiceData[] = [
  ...
  // === BUYBACK (4) ===
  {
    ...
    title: "사무가구 유통",
    subtitle:
      "사무실 이전, 축소, 리모델링 시 불필요한 사무가구를 AOVO가 합리적인 가격으로 유통합니다. 책상, 의자, 캐비닛, 파티션 등 보유 장비를 간편한 유통 절차로 정리하고 공간 효율화를 실현하세요. 무료 방문 견적과 당일 수거로 빠르게 자산을 정리할 수 있습니다.",
    heroGradient: "from-stone-900 to-stone-600",
    features: [
      {
        icon: "💰",
  ...
  },
  {
    ...
    title: "물류장비 유통",
    subtitle:
      "더 이상 사용하지 않는 롤테이너, 파랫트, 인테이너, 대차 등 물류장비를 AOVO가 합리적인 가격으로 유통합니다. 창고 축소, 물류 체계 변경 등으로 불필요해진 장비를 간편하게 정리하여 공간 효율화와 자산 회수를 동시에 실현하세요.",
  ...
  },
  {
    ...
    title: "행사집기 유통",
    subtitle:
      "행사 대행업체, 웨딩홀, 연회장 등에서 보유한 접이식 테이블, 연회 의자, 파티션, 무대장비 등 불필요한 행사집기를 AOVO가 합리적인 가격으로 유통합니다. 장비 교체, 업종 변경, 폐업 시 간편한 유통 절차로 공간 효율화와 자산 회수를 실현하세요.",
  ...
  },
  {
    ...
    title: "업소용집기 유통",
    subtitle:
      "식당 폐업, 리모델링, 업종 변경 시 보유한 업소용 주방장비와 집기를 AOVO가 합리적인 가격으로 유통합니다. 업소용 냉장고, 가스레인지, 식기세척기, 조리대, 테이블, 의자 등 불필요한 장비를 간편하게 정리하여 공간 효율화를 실현하세요.",
