...
const circularSteps = [
  ...
  { num: "03", icon: "✅", title: "품질 인증", desc: "3단계 품질 검증을 통과한 장비만 자산연대 인증을 부여합니다." },
...
const benefits = [
  ...
  { icon: "🌱", title: "ESG 경영 기여", desc: "자산연대 장비 도입으로 ESG 보고서에 활용 가능한 환경 기여 데이터와 인증서를 제공합니다." },
...
const equipment = [
  ...
  { name: "물류장비", desc: "롤테이너, 파랫트 등 자산연대", href: "/recycle/logistics", emoji: "📦" },
  { name: "사무가구/기기", desc: "책상, 의자, 복합기 자산연대", href: "/recycle/furniture", emoji: "🏢" },
  { name: "주방집기", desc: "업소용 주방장비 전문 재정비", href: "/recycle/kitchen", emoji: "🍳" },
  { name: "이동식에어컨", desc: "냉방기 전문 정비 자산연대", href: "/recycle/aircon", emoji: "❄️" },
  { name: "계절상품", desc: "시즌 장비 재정비 보관 서비스", href: "/recycle/seasonal", emoji: "🌸" },
  { name: "산업용제습기", desc: "제습기 전문 점검 자산연대", href: "/recycle/dehumidifier", emoji: "💧" },
  { name: "특수집기", desc: "특수 용도 장비 맞춤 재정비", href: "/recycle/special", emoji: "⚙️" },
];

const stats = [
  { value: "15,000+", label: "연간 자산연대 장비 수" },
      ...
      <section className="relative bg-gradient-to-br from-[#1a3a1a] to-[#2d6b2d] text-white pt-32 pb-20 overflow-hidden">
        ...
        <motion.div className="max-w-6xl mx-auto px-6 relative z-10" initial="hidden" animate="visible" variants={staggerContainer}>
          ...
          <motion.h1 variants={fadeInUp} className="font-paperlogy text-4xl md:text-5xl lg:text-6xl font-bold leading-tight mb-6">
            새것처럼 다시,<br />
            <span className="text-green-300">자산연대</span>서비스
          </motion.h1>
      ...
      <section className="py-24 bg-cream">
        <div className="max-w-6xl mx-auto px-6">
          <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={staggerContainer} className="text-center mb-16">
            ...
            <motion.h2 variants={fadeInUp} className="font-paperlogy text-3xl md:text-4xl font-bold text-primary">자산연대 프로세스</motion.h2>
          </motion.div>
      ...
      <section className="py-24 bg-white">
        <div className="max-w-6xl mx-auto px-6">
          <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={staggerContainer} className="text-center mb-16">
            ...
            <motion.h2 variants={fadeInUp} className="font-paperlogy text-3xl md:text-4xl font-bold text-primary">자산연대의 가치</motion.h2>
          </motion.div>
      ...
      <section className="py-24 bg-cream">
        <div className="max-w-6xl mx-auto px-6">
          <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={staggerContainer} className="text-center mb-16">
            ...
            <motion.h2 variants={fadeInUp} className="font-paperlogy text-3xl md:text-4xl font-bold text-primary">자산연대 대상 장비</motion.h2>
          </motion.div>
          <motion.div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6" initial="hidden" whileInView="visible" viewport={{ once: true }} variants={staggerContainer}>
            {equipment.map((e) => (
