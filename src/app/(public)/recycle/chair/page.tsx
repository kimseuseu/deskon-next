  ...
  return (
    <>
      ...
      <section data-hero-dark className="relative min-h-[60vh] flex items-center overflow-hidden pt-20">
        <Image src="/images/certa.png" alt="CERTA 리뉴얼 서비스" fill className="object-cover" priority />
      ...
      <section className="py-24 bg-cream">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <h2 className="font-paperlogy text-3xl md:text-4xl font-bold text-primary">리뉴얼 프로세스</h2>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              ...
              { step: "04", title: "리뉴얼 완료", desc: "재정비된 의자를 새 고객에게 배치합니다" },
            ].map((s) => (
      ...
      <section className="py-24 bg-surface">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="font-paperlogy text-3xl font-bold text-primary">리뉴얼 서비스의 가치</h2>
          </div>
      ...
      <section className="relative py-20 overflow-hidden">
        ...
        <div className="relative z-10 max-w-3xl mx-auto px-6 text-center">
          ...
          <p className="text-white/80 text-lg mb-10">
            aovochair.com에서 CERTA 리뉴얼 서비스를 자세히 확인하세요.
          </p>
