...
const milestones = [
  ...
  },
  {
    year: "2020",
    title: "순환서비스 시작",
    desc: "중고 산업용품 매입·재정비·재공급 순환경제 모델을 구축하고 ESG 경영을 본격화했습니다.",
  ...
  },
  {
    year: "2024",
    title: "도소매/유통 사업 개시",
    desc: "B2B 전용 도소매 유통 채널을 오픈하고 주방집기, 의료집기 등으로 카테고리를 다각화했습니다.",
  ...
  },
  {
    year: "2025",
    title: "통합 플랫폼 리뉴얼",
    desc: "구독·공유·렌탈·순환·유통 5대 서비스를 하나로 통합한 AOVO 플랫폼으로 리뉴얼 오픈했습니다.",
