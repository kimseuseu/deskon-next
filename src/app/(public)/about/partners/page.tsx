...
const programACards = [
  ...
  },
  {
    ...
    steps: [
      ...
      { num: "02", label: "아오보 소개", desc: "고객 연락처를 아오보 그룹에 전달합니다" },
      { num: "03", label: "상담 및 계약", desc: "아오보 그룹이 직접 고객을 상담하고 계약합니다" },
  ...
  },
  {
    ...
    scenario:
      "부동산 중개사 A씨는 사무실 임대 계약을 마친 고객에게 아오보 그룹을 소개했습니다. 고객은 사무가구 패키지 500만 원 계약을 체결했고, A씨는 별도 영업 없이 파트너 리워드를 D+7일 이내에 지급받았습니다. 소개만 했을 뿐인데 추가 수익이 발생한 것입니다.",
  },
];
...
const programBCards = [
  ...
  },
  {
    ...
    steps: [
      ...
      { num: "02", label: "현장 실사", desc: "아오보 그룹이 업장을 방문하여 배치 계획을 수립합니다" },
            ...
            <div className="lg:sticky lg:top-32 lg:self-start lg:h-fit py-24">
              ...
              <Reveal delay={200}>
                <p className="text-muted text-base leading-relaxed mb-10 max-w-md">
                  사무실 집기/가구가 필요한 고객을 아오보 그룹에 소개해 주세요. 아오보 그룹이 직접 상담하고 계약하며, 계약 성사 시 계약 규모에 따른 파트너 리워드를 지급합니다. 영업 부담 없이 소개만 하시면 됩니다.
                </p>
              </Reveal>
              <Reveal delay={300}>
